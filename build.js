...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_redirect__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_dontpad_integration__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_configs_from_location__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_file_saver__ = __webpack_require__(11);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_simplemde__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_simplemde___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_simplemde__);
...
__WEBPACK_IMPORTED_MODULE_0__src_redirect__["a" /* default */]();

var customSaveAction = {
    "name": "save-txt",
    "action": function action() {
        var blob = new Blob([simplemde.value()], { type: "text/plain;charset=utf-8" });
        __WEBPACK_IMPORTED_MODULE_3_file_saver___default.a.saveAs(blob, filename + ".txt");
    },
    "className": "fa fa-download p-float-right",
    "title": "Save file"
};

var toolbarOrderedItems = ["bold", "italic", "heading", "|", "quote", "unordered-list", "ordered-list", "|", "link", "image", "|", "preview", "side-by-side", "fullscreen", customSaveAction];

var dontpadIntegration = new __WEBPACK_IMPORTED_MODULE_1__src_dontpad_integration__["a" /* default */]("http://dontpad.com/markpad");
var configs = new __WEBPACK_IMPORTED_MODULE_2__src_configs_from_location__["a" /* default */]();
filename = configs.path.last;

simplemde = new __WEBPACK_IMPORTED_MODULE_4_simplemde___default.a({
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__json_to_params__ = __webpack_require__(8);


var DontpadIntegration = function DontpadIntegration(dontpadUrl) {

    var updateToDontpad = function updateToDontpad(mdContent) {
        fetch(dontpadUrl, {
            body: __WEBPACK_IMPORTED_MODULE_0__json_to_params__["a" /* default */]({ 'text': mdContent }),
            mode: 'no-cors',
            headers: new Headers({
    ...
    var getFromDontpad = function getFromDontpad() {
        return "getting content from dontpad";
    };

    return {
        dontpadUrl: dontpadUrl,
        updateToDontpad: updateToDontpad,
        getFromDontpad: getFromDontpad
    };
};

/* harmony default export */ __webpack_exports__["a"] = (DontpadIntegration);
...
"use strict";
var JSONToParams = function JSONToParams(object) {
    return Object.keys(object).map(function (k) {
        return encodeURIComponent(k) + '=' + encodeURIComponent(object[k]);
    }).join('&');
};
/* harmony default export */ __webpack_exports__["a"] = (JSONToParams);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__location_search_to_object__ = __webpack_require__(10);


var ConfigsFromLocation = function ConfigsFromLocation() {
    var location = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : window.location;


    var _getInfo = function _getInfo() {
        var info = location.pathname.substring(1) ? "" + location.pathname.substring(1) + location.search : location.hash.replace(/#!\//, "");
        info = info.split("?");
        return {
            path: { full: info[0], last: info[0].replace(/(.*)\/(.*)/, "$2") },
            search: __WEBPACK_IMPORTED_MODULE_0__location_search_to_object__["a" /* default */](info[1])
        };
    };
...
/* harmony default export */ __webpack_exports__["a"] = (ConfigsFromLocation);
...
var locationSearchToObject = function locationSearchToObject() {
    var queryString = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : window.location.search.substring(1);

    return queryString.split('&').map(function (str) {
...
/* harmony default export */ __webpack_exports__["a"] = (locationSearchToObject);
